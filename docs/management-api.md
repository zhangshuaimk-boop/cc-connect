...
```json
{
  "session_key": "feishu:chat_xxx:ou_xxx",
  "platform": "feishu"
}
```
...
```json
{
  ...
  "data": {
    ...
    "sessions_count": 3,
    "active_session_keys": ["feishu:chat_xxx:ou_xxx"] ,
    "heartbeat": {
      "enabled": true,
      "paused": false,
      "interval_mins": 30,
...
|--------------|--------|----------|--------------------------------------|
| `session_key`| string | yes      | Platform routing key (e.g. `feishu:chat_xxx:ou_xxx`) |
...
- [Feishu setup](feishu.md) — Feishu/Lark app configuration
